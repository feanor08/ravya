...
import { Scissors, Leaf, Globe, ClipboardCheck } from 'lucide-react';
                ...
                <Container>
                    ...
                    <div className="grid md:grid-cols-2 gap-12 items-center">
                        ...
                        <div className="bg-white p-6 rounded-2xl shadow-sm rotate-2">
                            <div className="aspect-video bg-[var(--color-bg)] rounded-lg flex items-center justify-center text-[var(--color-text-muted)]">
                ...
                <Container>
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        ...
                        <Card variant="flat" className="p-8">
                            <Scissors className="w-10 h-10 text-[var(--color-accent)] mb-4" />
                        ...
                        <Card variant="flat" className="p-8">
                            <Leaf className="w-10 h-10 text-[var(--color-accent)] mb-4" />
                        ...
                        <Card variant="flat" className="p-8">
                            <Globe className="w-10 h-10 text-[var(--color-accent)] mb-4" />
                        ...
                        <Card variant="flat" className="p-8">
                            <ClipboardCheck className="w-10 h-10 text-[var(--color-accent)] mb-4" />
